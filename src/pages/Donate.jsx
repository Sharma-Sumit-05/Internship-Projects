  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-24">
      ...
      <div className="flex flex-wrap gap-4 mb-10 justify-center">
        ...
        <span className="px-4 py-2 bg-slate-100 text-slate-600 rounded-lg font-bold text-sm">Secure Payment via Razorpay</span>
      </div>
      ...
      <div className="mt-16 border-t pt-10">
        <div className="grid md:grid-cols-2 gap-8 mb-10 text-sm text-slate-500">
          <div>
            <h4 className="font-bold text-slate-900 mb-2">Transparency & Refund</h4>
            <p>Donations are voluntary and non-refundable, as all funds are immediately utilized to support our active projects.</p>
          </div>
          <div>
            <h4 className="font-bold text-slate-900 mb-2">Donor Support</h4>
        ...
        <p className="font-bold mt-4 text-slate-900">— Prashant Shukla, Founder & President</p>
      </div>
    </div>
  );
}